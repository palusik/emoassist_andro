...
public class GraphView extends View {
     ...
     */
    public ArrayList<Float> hapinessValues1 = new ArrayList<Float>();
    /**
     * Array list containing one of the voice's happiness values
     */
    public ArrayList<Float> hapinessValues2 = new ArrayList<Float>();
    /**
     * The maximum number of points on the graph the more points the more detail the graph and also the lower the performance
     */
    public static int MaxNumberOfGraphPoints = 100;
    ...
    public void populateEmptyArray() {
        for( int i = 0; i < MaxNumberOfGraphPoints; i++) {
            hapinessValues1.add(-1.f);
            hapinessValues2.add(-1.f);
        }
    }
     ...
     * @param voiceType The voice identifier in a multi voice app
     */
    private void drawGraph(Canvas canvas, ArrayList<Float> happinessValues, VoiceType voiceType) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawGraph(canvas, hapinessValues1, VoiceType.Voice1);
        paint.setColor(Color.BLUE);
        drawGraph(canvas, hapinessValues2, VoiceType.Voice2);
